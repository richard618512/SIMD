...
// 编译指令如下
// g++ main.cpp train.cpp guessing.cpp md5_neon.cpp -o test.exe
//g++ main.cpp train.cpp guessing.cpp md5.cpp -o test.exe
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o test.exe -O1
//g++ main.cpp train.cpp guessing.cpp md5_neon.cpp -o test.exe -O1
// g++ main.cpp train.cpp guessing.cpp md5.cpp -o test.exe -O2
//g++ main.cpp train.cpp guessing.cpp md5_neon.cpp -o test.exe -O2
